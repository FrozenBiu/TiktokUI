...
export default function LeftSide() {
  return (
    <div className="w-[4.5rem] lg:w-[240px] px-[1rem] fixed left-0 top-0 h-full border-r-[0.5px] border-[#6a728262] lg:border-0">
      {/* Logo và thanh tìm kiếm */}
      <div className="pt-[1.25rem] pb-[0.5rem] w-full flex flex-col items-center lg:items-start lg:pl-2 gap-[1rem] shrink-0 cursor-pointer">
        {/* Logo Tiktok */}
        <a href="/">
          {/* Logo full */}
          <svg
        ...
        {/* Thanh tìm kiếm */}
        <div className="lg:flex items-center justify-center gap-1 inline-flex size-10 lg:w-[13rem] lg:h-[2.5rem] min-w-0 bg-[#1f1f1f] rounded-full lg:rounded-2xl">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-6 lg:ml-2 shrink-0 text-gray-300"
          >
            <path
              strokeLinecap="round"
          ...
          <input
            className="outline-0 hidden lg:block text-gray-300 font-medium"
            type="text"
