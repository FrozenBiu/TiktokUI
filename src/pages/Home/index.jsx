...
export default function Home() {
  return (
    <div className="h-full w-full py-3 flex justify-center items-center gap-4">
      {/* Video */}
      <div className="flex items-center">
        <div className="h-full flex items-end gap-2">
          {/* <video
            className="min-h-[618px] min-w-[348px] h-[calc(100vh-24px)] aspect-[9/16] rounded-2xl bg-amber-400"
            src=""
          ></video> */}
          <video
            className="min-w-[348px] w-[35vw] max-w-[500px] max-h-[calc(100vh-24px)] aspect-[9/16] rounded-2xl bg-amber-400"
            src=""
          ></video>
